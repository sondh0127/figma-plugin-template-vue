...
const vChecked = useVModel(props, 'checked')

function onChange(e: Event) {
  vChecked.value = (e.target as HTMLInputElement).checked
}
</script>
...
<template>
	<div class="fig-checkbox">
		<input
			...
			@change="onChange"
		/>
		<label class="fig-checkbox__label" :for="uniqueId">
			<slot>Item</slot>
		</label>
	</div>
</template>
